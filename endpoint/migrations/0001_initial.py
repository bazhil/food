# Generated by Django 4.0.6 on 2022-08-12 21:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional', models.ManyToManyField(blank=True, related_name='additional_from', to='endpoint.food', verbose_name='Дополнительные товары')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='food', to='endpoint.foodcategory', verbose_name='Раздел меню')),
            ],
            options={
                'abstract': False,
            },
